...
local function showSkinMenuTextUI(keyText, text)
    ...
    if isStartedResource(textUIResource) then
        local combinedText = ('[%s] %s'):format(safeKey, safeText)
        local openAttempts = {
            function()
                return exports[textUIResource]:open({
                    key = safeKey,
                    text = safeText
                })
            end,
            function()
                return exports[textUIResource]:open(safeText, safeKey)
            end,
            function()
                return exports[textUIResource]:Open({
                    key = safeKey,
            ...
            function()
                return exports[textUIResource]:DisplayHelpText(safeText, safeKey)
            end,
            function()
                return exports[textUIResource]:DisplayHelpText(combinedText)
            end,
            function()
                return exports[textUIResource]:ShowTextUI(combinedText)
            end,
            function()
                return exports[textUIResource]:showTextUI(combinedText)
            end
        ...
        for i = 1, #openAttempts do
            local success = pcall(openAttempts[i])
            if success then
                break
            end
        end
...
local function hideSkinMenuTextUI()
    ...
    if isStartedResource(textUIResource) then
        local closeAttempts = {
            function()
                return exports[textUIResource]:close()
            end,
            function()
                return exports[textUIResource]:Close()
            end,
            function()
                return exports[textUIResource]:HideHelpText()
            end,
            function()
                return exports[textUIResource]:HideTextUI()
            end,
            function()
                return exports[textUIResource]:hideTextUI()
            end
        ...
        for i = 1, #closeAttempts do
            local success = pcall(closeAttempts[i])
            if success then
                break
            end
        end
